...
#include <stdbool.h>
#include <errno.h> // Added to ensure errno is available
...
typedef struct cmd_buff
{
    ...
    bool append_mode; // extra credit, sets append mode from output_file
} cmd_buff_t;
...
#define CMD_ERR_EXECUTE "Execution failed\n"
